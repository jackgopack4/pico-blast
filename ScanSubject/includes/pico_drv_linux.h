/* pico_drv_linux.h
 * Interface to the linux pico driver.
 */

#ifndef _PICO_DRV_LINUX_H_
#define _PICO_DRV_LINUX_H_
...
class PicoDrvLinux : public PicoDrv {
        public:
                            PicoDrvLinux    (int devNum, bool readOnly=false);
        virtual             ~PicoDrvLinux   ();
